        ...
        <section className="bg-brand-50 overflow-hidden py-16">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2 lg:items-center text-center lg:text-left">
              ...
              <div className="flex justify-center lg:justify-end gap-4 text-black">
                <Button asChild size="lg" className="bg-white text-brand-900 hover:bg-slate-100">
                  <Link href="/booking">Book Now</Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="border-white text-brand-900 hover:bg-white/10 hover:text-brand-900">
